                                        ...
                                        <div
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <strong>Informasi Jadwal Interview</strong>
                                                            </h1>
                                                            <!--[if mso]></td></tr></table><![endif]-->
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">Kami ingin
                                                                    menginformasikan bahwa jadwal wawancara untuk
                                                                    pengajuan sertifikat SMK Anda telah ditetapkan.
                                                                    Silakan periksa detail jadwal yang telah kami
                                                                    tentukan di bawah ini. Pastikan Anda hadir sesuai
                                                                    dengan waktu dan metode wawancara yang telah
                                                                    ditentukan.</p>
                                                                <p style="line-height: 140%; margin-bottom: 15px;">
                                                                    Kegiatan akan dilakukan pada :</p>
                                                                <!-- Action -->
                                                            </div>
                                                        </td>
                                                    </tr>
                                            ...
                                            <table id="u_content_text_2" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:5px 60px 20px;margin-top:0;font-family:'Raleway',sans-serif;"
                                                            align="left">
                                                            <div class="v-text-align v-font-size"
                                                                style="font-size: 14px; line-height: 140%; text-align: justify; word-wrap: break-word;">
                                                                <ul style="line-height: 140%;">
                                                                    <li><strong>Waktu Pelakasaan:</strong>
                                                                        {{ $schedule }}</li>
                                                                    @if ($type === 'online')
                                                                    ...
                                                                    @endif
                                                                    @if ($type === 'offline')
                                                                        <li><strong>Lokasi:</strong> {{ $location }}
                                                                        </li>
                                                                    @endif
                                                                </ul>
                                                            </div>
