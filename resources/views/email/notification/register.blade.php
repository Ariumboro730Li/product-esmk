                ...
                <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td class="email-masthead content-cell" style="background-color: #26296e !important;">
                            <img src="data:image/png;base64,{{ $logo }}" class="email-masthead_logo" alt="E-SMK" />
                        </td>
                    </tr>
                    <!-- Email Body -->
                    <tr>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="{{ route('forgot.change', ['token' => $token]) }}" target="_blank">
                                                                        <div class="f-fallback button button--green">Ubah kata sandi</div>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                            ...
                                            <ul>
                                                <li style="font-size: 14px;">Jika Anda tidak mendaftar perusahaan pada website <b>e-SMK</b>, abaikan email ini.</li>
                                                <li style="font-size: 14px;">Email dikirimkan secara otomatis oleh sistem, mohon untuk tidak membalas email ini.</li>
                                                <li style="font-size: 14px;">Email ini dapat berisi informasi atau hal-hal yang secara hukum bersifat rahasia. Jika ada pertanyaan silakan hubungi info@mail.com atau 0812-xxxxxxx.</li>
                                            </ul>
                                            </p>
                                        </div>
                                    </td>
