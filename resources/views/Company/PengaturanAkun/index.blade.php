                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <div class="row g-3" >
                                            <div class="col-4">
                                                ...
                                                <h5 class="mb-0 total_aodt"></h5><small class="text-muted"></small>
                                            </div>
                                            <div class="col-4 border border-top-0 border-bottom-0">
                                                <h5 class="mb-0 total_aotdt"></h5><small
                                        ...
                                        <div class="d-inline-flex align-items-center justify-content-start w-100 mb-3"><i
                                            ...
                                            <p class="mb-0 company-address" style="word-break: break-word; overflow-wrap: anywhere; text-align: left;"></p>
                                        </div>
                                        <div class="d-inline-flex align-items-center justify-content-start w-100 mb-3">
    ...
    <script>
        ...
        async function getData() {
            ...
            let getDataRest = await CallAPI(
                'GET', `{{ url('') }}/api/company/dashboard/company/perusahaan`
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed == true) {
                        let postDataRest = await CallAPI('PUT',
                                '{{ url('') }}/api/company/pengaturan-akun/update',
                                formData)
                            .then(function(response) {
                                return response;
                            }).catch(function(error) {
