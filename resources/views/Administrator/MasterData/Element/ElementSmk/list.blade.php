@extends('...Administrator.index', ['title' => 'Data Element SMK'])
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0)">Master Data Element SMK</a></li>
                    </ul>
                </div>
    ...
    let paramsTable         = {};
        async function getListData(paramsTable) {
            ...
            const getDataRest = await CallAPI(
                    'GET',
                    '{{ url('') }}/api/internal/admin-panel/smk-element/list',
                    {
